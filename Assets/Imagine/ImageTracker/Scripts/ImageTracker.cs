...
namespace Imagine.WebAR
{
    ...
    public class ImageTracker : MonoBehaviour
    {
        ...
        public UnityEvent<bool> OnMarkerDetected;
        public UnityEvent<string> OnMarkerScan;
        ...
        void OnTrackingFound(string id)
        {
            ...
            OnMarkerDetected?.Invoke(true);
            OnMarkerScan?.Invoke(id);
        }
